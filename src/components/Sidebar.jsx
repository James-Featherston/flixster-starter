  ...
  return (
    ...
    {props.sidebarState ?
      <article id='sidebar-container'>
        <button onClick={handleHomeBtn} className='sidebar-button'>Home</button>
        <button onClick={handleFavoritesBtn} className='sidebar-button'>Favorites</button>
        <button onClick={handleWatchedBtn} className='sidebar-button'>Watched</button>
        <button onClick={handleCloseBtn}className='sidebar-button'>Close</button>
